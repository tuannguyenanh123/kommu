...
import { createWorkspace } from '@/actions/create-workspace';
 ...
 const Step1 = () => {
   ...
   return (
     <>
       ...
       <Typography
         text='This will be the name of your Kommu workspace - choose something that your team will recognize.'
 ...
 const Step2 = () => {
   ...
   const handleSubmit = async () => {
     ...
     if (error?.error || error?.insertError) {
           ...
           <div className='space-x-5'>
             ...
             {imageUrl ? (
               ...
               <Button
                 type='button'
                 size='sm'
                 className='hover:cursor-pointer text-white bg-gray-500'
               >
